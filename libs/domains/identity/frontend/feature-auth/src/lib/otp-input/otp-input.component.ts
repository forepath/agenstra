...
@Component({
  selector: 'identity-auth-otp-input',
  standalone: true,
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => IdentityOtpInputComponent),
      multi: true,
    },
  ],
})
export class IdentityOtpInputComponent implements ControlValueAccessor {
